...
public class FBHandler {
    ...
    private void addTimestamp (String db, String gameID) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.PUT, FB_URL + "databases/" + db + "/games/" + gameID + "/timestamp.json",
    ...
    public void addGameToFireBase(Game game) {
        ...
        String url = FB_URL + "databases/" + id + "/games/" + game.getId() + ".json";
        if (jsonObject != null) {
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.PUT, url, jsonObject,
                    response -> addTimestamp(id, game.getId()),
